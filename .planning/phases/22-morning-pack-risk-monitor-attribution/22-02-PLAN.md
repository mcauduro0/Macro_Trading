...
must_haves:
  ...
  key_links:
    ...
    - from: "src/pms/risk_monitor.py"
      ...
      via: "StressTester.run_all_scenarios()"
...
- **Stress tests**: If stress_tester available, run all DEFAULT_SCENARIOS against current positions (build simple positions list for stress_tester.run_all_scenarios). Else return empty list.

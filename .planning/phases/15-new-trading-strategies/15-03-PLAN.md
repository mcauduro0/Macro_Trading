...
<task type="auto">
  <name>Task 2: Tests for INF-02, INF-03, CUPOM-02</name>
  <files>
    tests/test_strategies/test_inf_cupom_new.py
  </files>
  <action>
...
- At least 12 tests total
  ...
  <done>>=12 tests pass confirming signal generation, IPCA calendar logic, breakeven benchmarking, and spread z-score computation for INF-02, INF-03, CUPOM-02</done>
</task>
...
5. Backtest smoke-test: `python -c "from src.strategies.inf_02_ipca_surprise import Inf02IpcaSurpriseStrategy; from src.strategies.inf_03_inflation_carry import Inf03InflationCarryStrategy; from src.strategies.cupom_02_onshore_offshore import Cupom02OnshoreOffshoreStrategy; from src.backtesting.engine import BacktestEngine; from src.backtesting.costs import TransactionCostModel; print('All 3 INF/CUPOM strategies compatible with BacktestEngine and TransactionCostModel')"` — confirms v2 framework compatibility
</verification>

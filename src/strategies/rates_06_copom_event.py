...
COPOM_DATES: list[date] = [
    # 2015
    date(2015, 1, 21), date(2015, 3, 4), date(2015, 4, 29),
    date(2015, 6, 3), date(2015, 7, 29), date(2015, 9, 2),
    date(2015, 10, 21), date(2015, 11, 25),
    # 2016
    date(2016, 1, 20), date(2016, 3, 2), date(2016, 4, 27),
    date(2016, 6, 8), date(2016, 7, 20), date(2016, 8, 31),
    date(2016, 10, 19), date(2016, 11, 30),
    # 2017
    date(2017, 1, 11), date(2017, 2, 22), date(2017, 4, 12),
    date(2017, 5, 31), date(2017, 7, 26), date(2017, 9, 6),
    date(2017, 10, 25), date(2017, 12, 6),
    # 2018
    date(2018, 2, 7), date(2018, 3, 21), date(2018, 5, 16),
    date(2018, 6, 20), date(2018, 8, 1), date(2018, 9, 19),
    date(2018, 10, 31), date(2018, 12, 12),
    # 2019
    date(2019, 2, 6), date(2019, 3, 20), date(2019, 5, 8),
    date(2019, 6, 19), date(2019, 7, 31), date(2019, 9, 18),
    date(2019, 10, 30), date(2019, 12, 11),
    # 2020
    date(2020, 2, 5), date(2020, 3, 18), date(2020, 5, 6),
    date(2020, 6, 17), date(2020, 8, 5), date(2020, 9, 16),
    date(2020, 10, 28), date(2020, 12, 9),
    # 2021
    date(2021, 1, 20), date(2021, 3, 17), date(2021, 5, 5),
    date(2021, 6, 16), date(2021, 8, 4), date(2021, 9, 22),
    date(2021, 10, 27), date(2021, 12, 8),
    # 2022
    date(2022, 2, 2), date(2022, 3, 16), date(2022, 5, 4),
    date(2022, 6, 15), date(2022, 8, 3), date(2022, 9, 21),
    date(2022, 10, 26), date(2022, 12, 7),
    # 2023
    date(2023, 2, 1), date(2023, 3, 22), date(2023, 5, 3),
    date(2023, 6, 21), date(2023, 8, 2), date(2023, 9, 20),
